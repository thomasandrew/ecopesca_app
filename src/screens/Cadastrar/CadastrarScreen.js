...
import { api } from "../../api"; // ajuste o caminho se sua pasta for diferente
...
export default function CadastrarScreen({ navigation }) {
  ...
  const disabled = !(nameOk && emailOk && pwdOk && match && avatar);
  ...
  return (
    ...
    >
      ...
      <View
        style={[styles.inputWrap, !emailOk && email && styles.inputWrapError]}
      >
      ...
      <View style={[styles.inputWrap, !pwdOk && pwd && styles.inputWrapError]}>
      ...
      <View style={[styles.inputWrap, !match && pwd2 && styles.inputWrapError]}>
